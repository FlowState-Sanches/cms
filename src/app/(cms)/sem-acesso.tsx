...
export function SemAcesso({ message, action }: SemAcessoProps) {
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-4 px-4 py-12 text-center md:px-6">
      ...
      {action ?? (
        <form action="/logout" method="post">
          <button
            type="submit"
            className="min-h-11 rounded-md border border-border px-4 py-2 text-sm text-text hover:border-primary lg:min-h-0"
          >
            Sair
          </button>
        </form>

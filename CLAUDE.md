...
- Layout mobile-first com `md:` (768 px) e `lg:` (1024 px), sem breakpoint customizado; o desktop não muda. Lista tabular nova usa `ResponsiveList`; ação principal tem `min-h-11` abaixo de 1024 px (`lg:min-h-0`); texto sem controle de tamanho usa `min-w-0 wrap-anywhere`. Rota nova entra em `e2e/cms-responsivo.spec.ts`. Ver "Layout responsivo" no `README.md`.
